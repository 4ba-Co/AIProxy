...
public sealed class JinaDeepSearchStrategy(
    IResultBuilder resultBuilder,
    ILogger<JinaDeepSearchStrategy> logger)
    : IProviderStrategy
{
    public string ProviderName => "jina-deepsearch";
